	...
	public function get_plugin_manager( $site_type, $theme_id ) {
		...
		<form action="<?php echo esc_url( add_query_arg( array( 'setup_action' => 'activate' ) ) ); ?>" method="post">
			...
			<div class="wrap">
				...
				One_And_One_Wizard_Header::render( 3, $site_type, $theme_id ); ?>

				<h3 class="clear"><?php esc_html_e( 'setup_assistant_plugins_title', '1and1-wordpress-wizard' ); ?></h3>
				<p>
					<?php
					printf(
						__( 'setup_assistant_plugins_description', '1and1-wordpress-wizard' ),
